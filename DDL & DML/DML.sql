...
INSERT INTO PARQUEADERO.RESERVA(
    ...
    ( SELECT K_CLIENTE FROM PARQUEADERO.CLIENTE WHERE NUMERO_IDENTIFICACION_CLIENTE = '1045698521'),
    NULL,
    NULL,
    ( SELECT K_SUCURSAL FROM PARQUEADERO.SUCURSAL WHERE NOMBRE_SUCURSAL = 'Sucursal Kennedy'),
    'A1',
    ( SELECT K_TARJETA_PAGO FROM PARQUEADERO.TARJETA_PAGO WHERE K_CLIENTE IN (SELECT K_CLIENTE FROM PARQUEADERO.CLIENTE WHERE NUMERO_IDENTIFICACION_CLIENTE = '1045698521')) ( SELECT CURRENT_TIMESTAMP AT TIME ZONE 'America/Bogota'),
    ( SELECT CURRENT_TIMESTAMP AT TIME ZONE 'America/Bogota'),
