...
BEGIN
    ...
    LOCK PARQUEADERO.DIRECCION IN ROW SHARE MODE;
    LOCK PARQUEADERO.SUCURSAL IN ROW SHARE MODE;
    LOCK PARQUEADERO.TARIFA_MINUTO IN ACCESS SHARE MODE;
    ...
    LOCK TABLE PARQUEADERO.TARIFA_MINUTO IN SHARE ROW EXCLUSIVE MODE;
...
BEGIN
    ...
    -- Bloquea temporalmente las filas que se van a modificar en la tabla
    LOCK PARQUEADERO.HORARIO_SUCURSAL IN ROW EXCLUSIVE MODE;
